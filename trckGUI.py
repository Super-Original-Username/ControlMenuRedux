...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gmailBox = QtWidgets.QLineEdit(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gmailBox.sizePolicy().hasHeightForWidth())
        self.gmailBox.setSizePolicy(sizePolicy)
        self.gmailBox.setObjectName("gmailBox")
        self.verticalLayout.addWidget(self.gmailBox)
        self.passBox = QtWidgets.QLineEdit(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.passBox.sizePolicy().hasHeightForWidth())
        self.passBox.setSizePolicy(sizePolicy)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.gmailBox.setPlaceholderText(_translate("MainWindow", "Gmail"))
        self.passBox.setPlaceholderText(_translate("MainWindow", "Password"))
